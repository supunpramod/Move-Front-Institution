    ...
    <footer className="border-t border-slate-200 bg-secondary text-white">
      <div className="max-w-6xl mx-auto px-4 py-12 grid md:grid-cols-4 gap-8">
        <div className="md:col-span-2">
          ...
          <div className="font-bold text-lg text-primary mt-5">Companies Act Registration</div>
          <p className="text-sm text-white mt-2 max-w-md">
        ...
        <div>
          <div className="font-semibold text-primary text-lg ">Quick Links</div>
          <div className="mt-3 flex flex-col gap-2 text-sm">
            <NavLink className="text-white hover:text-accent" to="/about">About</NavLink>
            <NavLink className="text-white hover:text-accent" to="/what-we-do">What We Do</NavLink>
            <NavLink className="text-white hover:text-accent" to="/funding-reports">Funding & Reports</NavLink>
            <NavLink className="text-white hover:text-accent" to="/contact">Contact</NavLink>
          </div>
        </div>

        <div>
  <div className="font-semibold text-primary text-lg">Contact</div>
