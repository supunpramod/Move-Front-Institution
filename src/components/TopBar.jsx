...
export default function TopBar() {
  return (
    <div className="bg-[#ffc121] text-white text-sm">
  ...
  <div className="flex items-center gap-2 hover:text-blue-600 transition">
    <Phone className="w-5 h-4 text-black" />
    <span className="text-black">031 2252610</span>
  </div>

  <div className="flex items-center gap-2 hover:text-red-600 transition">
    <Mail className="w-5 h-4 text-black" />
    <span className="text-black">chamika1969@gmail.com</span>
  </div>
